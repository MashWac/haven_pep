...
<main class="flex-1 flex flex-col h-full relative overflow-y-auto bg-background-light dark:bg-background-dark">
    <div class="layout-container flex flex-col w-full max-w-[1200px] mx-auto px-6 py-8">
        ...
        <div class="flex flex-wrap gap-2 mb-6 items-center">
            ...
            <a class="text-[#877b64] hover:text-[#DA70D6] text-sm font-medium" href="{{ url('/admin_courses') }}">Courses</a>
            <span class="material-symbols-outlined text-[#877b64] text-sm">chevron_right</span>
            <a class="text-[#877b64] hover:text-[#DA70D6] text-sm font-medium" href="{{ url('/admin_course_categories') }}">Course Categories</a>
            <span class="material-symbols-outlined text-[#877b64] text-sm">chevron_right</span>
        ...
        @endif
        <!-- FORM START -->
        <form action="{{ url('insert_course_category') }}" method="POST">
            @csrf
            ...
            <div class="flex flex-wrap justify-between items-end gap-4 mb-8 sticky top-0 bg-background-light dark:bg-background-dark z-20 py-2 border-b border-transparent">
                <div class="flex flex-col gap-2">
                    <h1 class="text-[#171511] dark:text-white text-3xl font-black">Add New Course Category</h1>
                    <p class="text-[#877b64] text-base">Fill in the details to add a new Course category.</p>
                </div>
