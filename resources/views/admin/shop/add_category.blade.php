...
<main class="flex-1 flex flex-col h-full relative overflow-y-auto bg-background-light dark:bg-background-dark">
    <div class="layout-container flex flex-col w-full max-w-[600px] mx-auto px-6 py-8">
        <div class="flex flex-wrap gap-2 mb-6 items-center">
            ...
            <span class="material-symbols-outlined text-[#877b64] text-sm">chevron_right</span>
            <span class="text-[#171511] dark:text-white text-sm font-medium">Add Category</span>
        </div>
        ...
        <div class="bg-white dark:bg-[#2c261a] rounded-xl p-8 shadow-sm border border-[#e5e2dc]/50 dark:border-[#362f22]">
            <div class="flex items-center gap-3 mb-6">
                <div class="w-10 h-10 rounded-lg bg-[#DA70D6]/10 flex items-center justify-center">
                    <span class="material-symbols-outlined text-[#DA70D6]">add_circle</span>
                </div>
                <div>
                    <h1 class="text-[#171511] dark:text-white text-2xl font-black">Add Category</h1>
                    <p class="text-[#877b64] text-sm">Create a new shop item category.</p>
                </div>
            </div>

            <form action="{{ url('/admin_shop_categories/insert') }}" method="POST">
                @csrf
                <div class="flex flex-col gap-5">
                    ...
                    <label class="flex flex-col gap-2">
                        ...
                        <textarea name="description" rows="4"
                            class="w-full rounded-lg border border-[#e5e2dc] bg-background-light dark:bg-[#362f22] dark:border-[#4a402e] dark:text-white p-4 text-base focus:ring-2 focus:ring-[#DA70D6]/20 focus:border-[#DA70D6] outline-none transition-all resize-none placeholder:text-[#877b64]"
